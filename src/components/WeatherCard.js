...
const WeatherCard = ({ weather }) => {
  ...
  return (
    <div style={{ backgroundImage: `url(${weatherImage})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '300px' }} className="bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row md:space-x-4">
      ...
      <div className="bg-gray-100 p-4 bg-opacity-30 rounded-lg md:w-96">
      ...
      <div className='flex-col w-96 bg-opacity-30 '>
        <div className="bg-gray-100 p-4 rounded-lg flex-1 bg-opacity-30 ">
          <div className="mb-4 grid grid-cols-2 md:grid-cols-5 gap-4">
            {dailyData.map((day, index) => (
              <div key={index} className={`bg-gray-100 p-4 rounded-lg bg-opacity-30 ${index > 4 ? 'mt-4  pt-4' : ''}`}>
        ...
        <div className="bg-gray-100 p-4 rounded-lg flex-1 mt-4 bg-opacity-30 ">
          <div>
